...
func (e *Engine) handleTimeout(resetTimer func(time.Duration)) {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeActionTimeout, ws.ActionTimeoutPayload{
		PlayerID: p.UserID,
...
func (e *Engine) handleAction(
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeActionTaken, ws.ActionTakenPayload{
		PlayerID: msg.SenderID,
		Action:   cmd.Action,
...
func (e *Engine) handleChat(msg ws.InboundMessage) {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeChatMessage, ws.ChatPayload{
...
func (e *Engine) startHand(resetTimer func(time.Duration)) {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeGameStarted, ws.GameStartedPayload{
	...
	for _, p := range e.gs.Seats {
		...
		e.rc.SendTo(p.UserID, ws.MustEvent(ws.TypeHoleCards, ws.HoleCardsPayload{
			PlayerID: p.UserID,
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeCardsDealt, ws.CardsDealtPayload{Seats: dealtSeats}))
...
func (e *Engine) nextStreet(resetTimer func(time.Duration)) {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeStreetStarted, ws.StreetStartedPayload{
		Street:    e.gs.Street.String(),
...
func (e *Engine) broadcastActionRequired(resetTimer func(time.Duration)) {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeActionRequired, ws.ActionRequiredPayload{
		PlayerID:   p.UserID,
...
func (e *Engine) runShowdown(resetTimer func(time.Duration)) {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeShowdown, json.RawMessage(rawReveals)))
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeHandResult, json.RawMessage(rawResult)))
...
func (e *Engine) broadcastReadyStatus() {
	...
	e.rc.Broadcast(ws.MustEvent(ws.TypeReadyStatus, struct {
