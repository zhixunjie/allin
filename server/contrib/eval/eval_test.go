...
func c(r, s byte) model.Card { return model.Card{Rank: r, Suit: s} }

func TestRoyalFlush(t *testing.T) {
	hand := [7]model.Card{c('A', 's'), c('K', 's'), c('Q', 's'), c('J', 's'), c('T', 's'), c('2', 'c'), c('3', 'd')}
	rank := Evaluate7(hand)
...
func TestStraightFlush(t *testing.T) {
	hand := [7]model.Card{c('9', 'h'), c('8', 'h'), c('7', 'h'), c('6', 'h'), c('5', 'h'), c('A', 'c'), c('K', 'd')}
	rank := Evaluate7(hand)
	if model.HandCategory(rank>>20) != model.CatStraightFlush {
...
func TestFourOfAKind(t *testing.T) {
	hand := [7]model.Card{c('A', 's'), c('A', 'h'), c('A', 'd'), c('A', 'c'), c('K', 's'), c('2', 'c'), c('3', 'd')}
	rank := Evaluate7(hand)
...
func TestFullHouse(t *testing.T) {
	hand := [7]model.Card{c('K', 's'), c('K', 'h'), c('K', 'd'), c('Q', 'c'), c('Q', 's'), c('2', 'c'), c('3', 'd')}
	rank := Evaluate7(hand)
...
func TestFlush(t *testing.T) {
	hand := [7]model.Card{c('A', 'c'), c('T', 'c'), c('7', 'c'), c('4', 'c'), c('2', 'c'), c('K', 'd'), c('Q', 's')}
	rank := Evaluate7(hand)
...
func TestStraight(t *testing.T) {
	hand := [7]model.Card{c('9', 's'), c('8', 'h'), c('7', 'd'), c('6', 'c'), c('5', 's'), c('A', 'c'), c('K', 'd')}
	rank := Evaluate7(hand)
...
func TestWheelStraight(t *testing.T) {
	hand := [7]model.Card{c('A', 's'), c('2', 'h'), c('3', 'd'), c('4', 'c'), c('5', 's'), c('K', 'c'), c('Q', 'd')}
	rank := Evaluate7(hand)
	if Describe(rank) != "Straight" {
...
func TestThreeOfAKind(t *testing.T) {
	hand := [7]model.Card{c('J', 's'), c('J', 'h'), c('J', 'd'), c('A', 'c'), c('K', 's'), c('2', 'c'), c('3', 'd')}
	rank := Evaluate7(hand)
...
func TestTwoPair(t *testing.T) {
	hand := [7]model.Card{c('A', 's'), c('A', 'h'), c('K', 'd'), c('K', 'c'), c('Q', 's'), c('2', 'c'), c('3', 'd')}
	rank := Evaluate7(hand)
...
func TestOnePair(t *testing.T) {
	hand := [7]model.Card{c('A', 's'), c('A', 'h'), c('K', 'd'), c('Q', 'c'), c('J', 's'), c('2', 'c'), c('3', 'd')}
	rank := Evaluate7(hand)
...
func TestHighCard(t *testing.T) {
	hand := [7]model.Card{c('A', 's'), c('K', 'h'), c('Q', 'd'), c('J', 'c'), c('9', 's'), c('2', 'c'), c('4', 'd')}
	rank := Evaluate7(hand)
...
func TestOrdering_SFBeatsQuads(t *testing.T) {
	sf := Evaluate7([7]model.Card{c('9', 'h'), c('8', 'h'), c('7', 'h'), c('6', 'h'), c('5', 'h'), c('A', 'c'), c('K', 'd')})
	quads := Evaluate7([7]model.Card{c('A', 's'), c('A', 'h'), c('A', 'd'), c('A', 'c'), c('K', 's'), c('2', 'c'), c('3', 'd')})
	if sf >= quads {
...
func TestOrdering_QuadsBeatsFullHouse(t *testing.T) {
	quads := Evaluate7([7]model.Card{c('A', 's'), c('A', 'h'), c('A', 'd'), c('A', 'c'), c('K', 's'), c('2', 'c'), c('3', 'd')})
	fh := Evaluate7([7]model.Card{c('K', 's'), c('K', 'h'), c('K', 'd'), c('Q', 'c'), c('Q', 's'), c('2', 'c'), c('3', 'd')})
	if quads >= fh {
...
func TestOrdering_HigherQuadsWin(t *testing.T) {
	acesQuads := Evaluate7([7]model.Card{c('A', 's'), c('A', 'h'), c('A', 'd'), c('A', 'c'), c('K', 's'), c('2', 'c'), c('3', 'd')})
	kingsQuads := Evaluate7([7]model.Card{c('K', 's'), c('K', 'h'), c('K', 'd'), c('K', 'c'), c('A', 's'), c('2', 'c'), c('3', 'd')})
...
func TestOrdering_BestFlush(t *testing.T) {
	aceHighFlush := Evaluate7([7]model.Card{c('A', 'c'), c('K', 'c'), c('Q', 'c'), c('J', 'c'), c('9', 'c'), c('2', 'd'), c('3', 's')})
	kingHighFlush := Evaluate7([7]model.Card{c('K', 'c'), c('Q', 'c'), c('J', 'c'), c('T', 'c'), c('8', 'c'), c('2', 'd'), c('3', 's')})
